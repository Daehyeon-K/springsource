...
public class BookController {
	...
	// /book/1000 + PUT + body(수정내용 - json 형태) ==> 성공시 success, 실패시 fail
	// /book/1000/2500 이렇게 받아도 됨. 근데 이렇게 말고 PUT 넣고 body 받을 것임
	...
	// /book/new + POST + body ==> 신규 도서 입력 ==> 성공시 success, 실패시 fail
	@PostMapping("/new")
